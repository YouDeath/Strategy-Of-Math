...
if MapInfoArr[positionX,positionY] == 4 or MapInfoArr[positionX,positionY] == 5 {
	if firstly == true{
		if random(1) < ds_map_find_value(global.settingsGame,"generateChanceRange"){
			MapInfoArr[positionX,positionY] = 5
		...
		if random(1) < ds_map_find_value(global.settingsGame,"generateChanceRangeMore"){
			MapInfoArr[positionX,positionY] = 5
			for(iniArr[positionX,positionY] = -1; iniArr[positionX,positionY] < 2; iniArr[positionX,positionY]++){
				for(injArr[positionX,positionY] = -1; injArr[positionX,positionY] < 2; injArr[positionX,positionY]++){
